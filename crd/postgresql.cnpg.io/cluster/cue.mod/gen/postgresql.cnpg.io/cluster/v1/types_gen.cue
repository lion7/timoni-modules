...
//timoni:generate timoni mod vendor crd -f https://raw.githubusercontent.com/cloudnative-pg/cloudnative-pg/refs/heads/main/config/crd/bases/postgresql.cnpg.io_clusters.yaml
	...
	bootstrap?: {
		...
		initdb?: {
			...
			import?: {
				...
				// IMPORTANT:
				// Use these options with caution and at your own risk, as the
				// operator
				// does not validate their content. Be aware that certain options
				// may
