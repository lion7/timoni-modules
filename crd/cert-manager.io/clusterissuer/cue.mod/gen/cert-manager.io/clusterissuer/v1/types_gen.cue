...
//timoni:generate timoni vendor crd -f https://raw.githubusercontent.com/cert-manager/cert-manager/refs/heads/master/deploy/crds/crd-clusterissuers.yaml

package v1

import "strings"

// A ClusterIssuer represents a certificate issuing authority
// which can be
// referenced as part of `issuerRef` fields.
// It is similar to an Issuer, however it is cluster-scoped and
// therefore can
// be referenced by resources that exist in *any* namespace, not
// just the same
